...
import struct
import datetime
from typing import List, Dict, Any, BinaryIO, TYPE_CHECKING
...
class FITFileWriter:
    ...
    def create_workout_file(self, segments: List['WorkoutSegment'], output_path: str, 
                           workout_name: str = "Workout", ftp: int = 250) -> int:
        """
